  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF9F6] transition-colors">
      <main className="flex-grow flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        {/* Scholarly highlight background glow */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[600px] h-[600px] rounded-full bg-[#D4A373]/25 blur-[160px]" />
        </div>

        {/* Soft section separation blob */}
        <div
        ...
        <div className="relative z-10 max-w-2xl w-full text-center py-16">
          ...
          {/* Illustration */}
          <div className="mb-10 p-8 rounded-full bg-[#F5EBDD] shadow-soft ring-1 ring-[#D4A373]/30 inline-block">
            <svg
              className="text-[#333333]/40"
              width="120"
              height="120"
              viewBox="0 0 120 120"
              fill="none"
            >
              ...
              <path d="M60 35V67" stroke="#B85C38" strokeWidth="1.5" />
          ...
          <p className="text-lg text-[#333333]/70 max-w-md mx-auto mb-10 font-light">
